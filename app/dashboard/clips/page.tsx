      ...
      {filteredClips.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {filteredClips.map((clip) => (
            ...
            >
              {/* Thumbnail */}
              <Link href={`/dashboard/edit/${clip.id}`}>
              ...
              <div className="p-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-1">
                    <Link href={`/dashboard/edit/${clip.id}`}>
                      <button className="p-1.5 text-zinc-500 hover:text-white hover:bg-zinc-800 rounded transition">
              ...
              {filteredClips.map((clip) => (
                <tr key={clip.id} className="border-b border-zinc-800 last:border-0 hover:bg-zinc-800/50 transition">
                  <td className="px-4 py-3">
                    <Link href={`/dashboard/edit/${clip.id}`} className="flex items-center gap-3">
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-1">
                      <Link href={`/dashboard/edit/${clip.id}`}>
                        <button className="p-2 text-zinc-500 hover:text-white hover:bg-zinc-700 rounded transition">
                          <Edit3 className="w-4 h-4" />
                        </button>
                      </Link>
                      <button className="p-2 text-zinc-500 hover:text-white hover:bg-zinc-700 rounded transition">
