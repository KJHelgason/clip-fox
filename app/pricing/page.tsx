...
function PricingContent() {
  ...
  const [interval, setIntervalState] = useState<BillingInterval>(initialInterval)
  const [loading, setLoading] = useState<string | null>(null)
  const [user, setUser] = useState<{ id: string } | null>(null)

  const setInterval = useCallback((newInterval: BillingInterval) => {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-zinc-200">
            <div className="flex items-center gap-4 mb-4 md:mb-0">
              <a href="#" className="text-zinc-400 hover:text-zinc-600 transition" aria-label="Discord">
              ...
              <a href="#" className="text-zinc-400 hover:text-zinc-600 transition" aria-label="X (Twitter)">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                </svg>
              </a>
              <a href="#" className="text-zinc-400 hover:text-zinc-600 transition" aria-label="Instagram">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a href="#" className="text-zinc-400 hover:text-zinc-600 transition" aria-label="TikTok">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
...
export default function PricingPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-gradient-to-b from-purple-600 via-purple-500 to-purple-400" />}>
      <PricingContent />
    </Suspense>
  )
}
